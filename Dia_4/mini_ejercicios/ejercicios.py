# #LISTAS
# Crea una lista con 5 cosas que te gustan.
# Imprime solo la tercera.
...
# Agrega una más.
# Intenta agregar un duplicado.
# Imprime todos los elementos.

cosas_odiosas = {"Tráfico", "Esperar", "ordenar"}
print("Set original:", cosas_odiosas)
cosas_odiosas.add("Colas")
cosas_odiosas.add("Tráfico")  # Intento de duplicado
print("Set después de agregar una cosa más:", cosas_odiosas)
