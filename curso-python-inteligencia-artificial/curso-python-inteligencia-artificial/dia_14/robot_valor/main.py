...
entorno = Entorno(ancho=5, alto=5, cantidad_objetos=5)
robot = Robot("RobotValor", posicion=(2, 2))
...
robot.resumen_final()
robot.exportar_log("dia_14/robot_valor/log/log_robot_valor_dia14.txt")
